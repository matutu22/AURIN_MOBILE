...
open class ChartUtils
{
    ...
    internal class func drawMultilineText(context: CGContext, text: String, knownTextSize: CGSize, point: CGPoint, attributes: [String : AnyObject]?, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: CGFloat)
    {
        ...
        if angleRadians != 0.0
        {
            ...
            (text as NSString).draw(with: rect, options: NSString.DrawingOptions.usesLineFragmentOrigin, attributes: attributes, context: nil)
    ...
    {
        let rect = text.boundingRect(with: constrainedToSize, options: NSString.DrawingOptions.usesLineFragmentOrigin, attributes: attributes, context: nil)
